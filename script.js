function submitData() {
 ...
 window.export.onclick = function() {
   ...
   css = (
     ...
     'div.WordSection1 {page: WordSection1;}'+'.h3andamount{font-size: 2em;}'+'</style>'
   );
   
   html = window.div2.innerHTML;
   ...
   if (navigator.msSaveOrOpenBlob ) navigator.msSaveOrOpenBlob( blob, 'Vinod.doc'); // IE10-11
